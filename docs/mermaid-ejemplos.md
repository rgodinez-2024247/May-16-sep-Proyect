...
Estos diagramas estaban en el `README.md` y se movieron aquí para dejar el README enfocado en las
instrucciones del proyecto. Son ejemplos genéricos de la sintaxis de Mermaid, no describen esta
página-regalo.
